...
import { supabase } from '../supabaseClient' // direct import
...
export default function Login() {
  ...
  async function handleLogin(e) {
    ...
    // ── supabase.auth.signInWithPassword() called directly ────────────────
    ...
    if (signInError) {
      ...
      if (msg.includes('email not confirmed')) {
        setError('❌ Please confirm your email address before signing in. Check your inbox (and spam folder).')
      } else if (msg.includes('invalid login') || msg.includes('invalid credentials')) {
        setError('❌ Invalid email or password. Did you confirm your email?')
      } else {
