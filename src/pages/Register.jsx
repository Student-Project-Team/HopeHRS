...
export default function Register() {
  ...
  // ---------- Google user: just navigate (profiles handled in PR-04) ----------
  ...
  async function handleRegister(e) {
    ...
    // Supabase silently returns identities: [] when email is already confirmed.
    // This means the user already exists — treat it as a duplicate.
    ...
    // Save the username to localStorage after successful registration
