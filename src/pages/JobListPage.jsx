          ...
          <table className="w-full min-w-[800px]">
            <thead>
              <tr className="border-b border-slate-100 bg-slate-50">
                ...
                {isAdminPlus && (
                  <th className="px-3 py-2.5 text-left text-[10px] font-bold text-slate-400 uppercase tracking-wider whitespace-nowrap pr-8">Actions</th>
                )}
              </tr>
            </thead>
                ...
                <tr key={job.jobCode} className="hover:bg-slate-50 transition-colors duration-100">
                  ...
                  {isAdminPlus && (
                    <td className="px-3 py-3">
                      <span className="text-[10px] text-slate-400 block max-w-[200px] truncate" title={job.stamp}>
                        {job.stamp || '—'}
                      </span>
                    </td>
                  )}
