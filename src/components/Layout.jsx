...
export default function Layout() {
  ...
  // ✅ Change: use 'logout' instead of 'signOut'
  ...
  async function handleLogout() {
    // ✅ Now 'logout' is defined and calls supabase.auth.signOut()
    await logout();
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      <Navbar user={{ name: displayName, email: currentUser?.email }} onToggleSidebar={toggleSidebar} onLogout={handleLogout} />
